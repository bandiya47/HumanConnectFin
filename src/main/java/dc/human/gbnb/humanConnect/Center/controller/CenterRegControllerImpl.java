...
public class CenterRegControllerImpl implements CenterRegController {
	...
	@Override
	@RequestMapping(value= "/Center/centerReg.do", method = RequestMethod.GET)
...
//		List membersList = memberService.listMembers();
		...
		ModelAndView mav = new ModelAndView("/Center/centerReg");
...
//		mav.addObject("membersList", membersList);
	...
	@Override
	@RequestMapping(value="/Human_connect/addCenterReg.do" ,method = RequestMethod.POST)
	@ResponseBody
