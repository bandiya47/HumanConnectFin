	    ...
	    <jsp:include page="neviCenter.jsp" />
		        ...
		        <table class="cen80terRegTable">
		            <tr>
		                ...
		                <td>
		                    <div id="startTimeCheck"></div><input id="startTime" class="centerRegDateLeft" type="time" name="vStartTime">
		                    ~
		                    <input id="endTime" class="centerRegDateRight" type="time" name="vLastTime"><div id="endTimeCheck"></div>
		                </td>
		            </tr>
		            <tr>
		                <td class="centerRegTd">모집기간</td>
		                <td>
		                    <div id="rStartDateCheck"></div><input id="rStartDate" class="centerRegDateLeft" type="date" name="vRStartDate">
		                    ~
		                    <input id="rEndDate" class="centerRegDateRight" type="date" name="vREndDate"><div id="rEndDateCheck"></div>
		                </td>
		            ...
		            <tr>
		                ...
		                <td><input class="centervRegAmnt" id="vRegAmnt" type="text" name="vRegAmnt" placeholder="모집인원을 입력해주세요."><div id="vRegAmntCheck"></div></td>
		            ...
		            <tr>
		                ...
		                <td colspan="3"><input id="file" type="file" name="vUploadFilePath"><div id="vUploadFilePathCheck"></div></td>
		            </tr>
		        </table>
		        <div class="centerRegDiv2">
		            <textarea id="info" name="vInfo"  placeholder="자격요건, 주의사항, 상세내용, 등을 입력해주세요."></textarea><div id="infoCheck"></div>
		        </div>
		        </div>
